...
sudo apt update
sudo apt install git gcc g++ flex bison build-essential fakeroot libncurses5-dev libssl-dev ccache flex bison libelf-dev dwarves busybox qemu-system-x86 patchelf cmake libevent-dev gcc-9 g++9 python3-pip
